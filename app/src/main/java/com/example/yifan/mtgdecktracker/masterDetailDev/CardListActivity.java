...
public class CardListActivity extends AppCompatActivity {
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        private final List<DummyContent.CardItem> mValues;

        public SimpleItemRecyclerViewAdapter(List<DummyContent.CardItem> items) {
            mValues = items;
        }
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            holder.mIdView.setText(mValues.get(position).cardName);
            holder.mContentView.setText(mValues.get(position).imageURL);
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(CardDetailFragment.ARG_ITEM_ID, holder.mItem.cardName);
                        ...
                        intent.putExtra(CardDetailFragment.ARG_ITEM_ID, holder.mItem.cardName);
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public DummyContent.CardItem mItem;
